...
public class DashBoardFormController {
    ...
    public void initialize() throws SQLException {
        ...
        setCellValueFactory();
        countEmployee();
      TimeController.timeNow(dateLbl,timeLbl);
    }
    ...
    public void countEmployee() throws SQLException{
        String count=String.valueOf(EmployeeModel.countEmployee());
        this.LblEmpCount.setText(count);

    }
    public void countOrder() throws SQLException{
        String count=String.valueOf(OrderModel.countOrder());
        this.lblOrderCount.setText(count);

    }
    public void countProduct() throws SQLException{
        String count=String.valueOf(ProductModel.countProduct());
        this.lblProduct.setText(count);
