...
public class OrderFormController {
    ...
    @FXML
    private Label custdValidateLbl;

    @FXML
    private Label orderDateLbl;

    @FXML
    private Label orderDesc;

    @FXML
    private Label orderIdValidatelbl;

    @FXML
    private Label orderPriceValidateLbl;
    ...
    @FXML
    private Label payIdValidateLbl;
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        String date = String.valueOf(orderDate.getValue());

        var dto = new OrderDto(OrderId,B_id,Pay_id,price,description,Qty,date);

        var model = new OrderModel();
        if (DataValidateController.orderIdValidate(txtOrderId.getText())) {
            orderIdValidatelbl.setText("");
            if (DataValidateController.priceValidate(txtOrderPrice.getText())) {
                orderPriceValidateLbl.setText("");
                if (DataValidateController.quantityValidate(txtQty.getText())) {
                    orderQtyLbl.setText("");
                ...
                txtOrderPrice.setText("Invalid price");
            }
        }else{
