package lk.ijse.apparelHub.util;
...
import java.util.regex.Pattern;
    ...
    public class DataValidateController {
        ...
        public static boolean orderIdValidate(String orderId){
            String orderRegex = "^(O)[0-9]{3}$";
        ...
        public static boolean quantityValidate(String qty) {
